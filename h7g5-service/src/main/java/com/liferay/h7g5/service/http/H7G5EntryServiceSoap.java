...
public class H7G5EntryServiceSoap {
	...
	public static com.liferay.h7g5.model.H7G5EntrySoap[] getByH7G5FolderId(
			long h7g5FolderId, int start, int end)
		throws RemoteException {

		try {
			java.util.List<com.liferay.h7g5.model.H7G5Entry> returnValue =
				H7G5EntryServiceUtil.getByH7G5FolderId(
	...
	public static com.liferay.h7g5.model.H7G5EntrySoap getByKey(
			String folderKey)
		throws RemoteException {

		try {
			com.liferay.h7g5.model.H7G5Entry returnValue =
				H7G5EntryServiceUtil.getByKey(folderKey);
	...
	public static com.liferay.h7g5.model.H7G5EntrySoap[] getByName(
			String folderName, int start, int end)
		throws RemoteException {

		try {
			java.util.List<com.liferay.h7g5.model.H7G5Entry> returnValue =
				H7G5EntryServiceUtil.getByName(folderName, start, end);
	...
	public static com.liferay.h7g5.model.H7G5EntrySoap getByH_D_N(
			long h7g5FolderId, String description, String name)
		throws RemoteException {

		try {
			com.liferay.h7g5.model.H7G5Entry returnValue =
				H7G5EntryServiceUtil.getByH_D_N(
