...
public class H7G5EntryServiceUtil {
	 ...
	 */
	public static List<H7G5Entry> getByH7G5FolderId(
			long h7g5FolderId, int start, int end)
		throws PortalException {

		return getService().getByH7G5FolderId(h7g5FolderId, start, end);
	}

	public static H7G5Entry getByH_D_N(
			long h7g5FolderId, String description, String name)
		throws PortalException {

		return getService().getByH_D_N(h7g5FolderId, description, name);
	}

	public static H7G5Entry getByKey(String folderKey) throws PortalException {
		return getService().getByKey(folderKey);
	}

	public static List<H7G5Entry> getByName(
			String folderName, int start, int end)
		throws PortalException {

		return getService().getByName(folderName, start, end);
	}
