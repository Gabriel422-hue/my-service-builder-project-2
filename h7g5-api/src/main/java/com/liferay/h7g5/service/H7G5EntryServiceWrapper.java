...
public class H7G5EntryServiceWrapper
	...
	@Override
	public java.util.List<com.liferay.h7g5.model.H7G5Entry> getByH7G5FolderId(
			long h7g5FolderId, int start, int end)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _h7g5EntryService.getByH7G5FolderId(h7g5FolderId, start, end);
	}

	@Override
	public com.liferay.h7g5.model.H7G5Entry getByH_D_N(
			long h7g5FolderId, String description, String name)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _h7g5EntryService.getByH_D_N(h7g5FolderId, description, name);
	}

	@Override
	public com.liferay.h7g5.model.H7G5Entry getByKey(String folderKey)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _h7g5EntryService.getByKey(folderKey);
	}

	@Override
	public java.util.List<com.liferay.h7g5.model.H7G5Entry> getByName(
			String folderName, int start, int end)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _h7g5EntryService.getByName(folderName, start, end);
	}
